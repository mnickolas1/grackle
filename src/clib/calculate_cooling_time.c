...
extern void FORTRAN_NAME(cool_multi_time_g)(
	...
	double *h2ltea, double *gasgra,
        ...
        int *iradtrans, double *photogammaHI, double *photogammaHeI, double *photogammaHeII,
                                 ...
                                 gr_float *cooling_time)
{
  ...
  /* Call the fortran routine to solve cooling equations. */
    ...
    FORTRAN_NAME(cool_multi_time_g)(
       ...
       my_fields->RT_HI_heating_rate,
       my_fields->RT_HeI_heating_rate,
       my_fields->RT_HeII_heating_rate,
